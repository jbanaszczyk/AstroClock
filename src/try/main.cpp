...
#ifndef DEBUG_IOT_ASTROCLOCK
#define DEBUG_IOT_ASTROCLOCK TRACE
#endif

SimpleLogging::Logger *logger = nullptr;
...
void setup() {
	...
	logger = Logging.getLogger("AstroClock", Logging.DEBUG_IOT_ASTROCLOCK);
}
