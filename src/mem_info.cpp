...
//}
//
//void info_print_memory_layout_line(const char * name, unsigned long bytes, bool reset) {
...
//}
//
//void info_print_memory_layout_line(const char * name, unsigned long bytes) {
